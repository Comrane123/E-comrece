...
class Smartphone(Product):
    ...
    ram = models.CharField(max_length=255, verbose_name="RAM")
    sd = models.BooleanField(default=True, verbose_name="Presence of SD card")
    sd_volume_max = models.CharField(max_length=255, verbose_name="Maximum SD volume", null=True, blank=True)
